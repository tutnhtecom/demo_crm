...
return new class extends Migration
{
    ...
    {
        Schema::create('educations_types', function (Blueprint $table) {
            $table->id();
            $table->string('name')->nullable(FALSE)->default(NULL)->comment('Lưu Tên loại tốt nghiệp');            
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('educations_types');
    }
};
