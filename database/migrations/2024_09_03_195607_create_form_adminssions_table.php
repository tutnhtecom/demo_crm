...
return new class extends Migration
{
    ...
    {
        Schema::create('form_adminssions', function (Blueprint $table) {
            $table->id();
            $table->string('name')->nullable(FALSE)->default(NULL)->comment('Lưu tên của hình thức xét tuyển');
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('form_adminssions');
    }
};
