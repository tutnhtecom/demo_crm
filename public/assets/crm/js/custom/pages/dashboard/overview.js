...
var TI_Overview = function () {
  ...
  var htmlLegendPlugin = {
    ...
    var initialChart = function(){
      ...
      // Init ChartJS -- for more info, please visit: https://www.chartjs.org/docs/latest/
      window.chartStatus = new Chart(ctx, config);
      return window.chartStatus;
    }
  ...
  var initialChart2 = function() {
    ...
    // Init ChartJS -- for more info, please visit: https://www.chartjs.org/docs/latest/
    window.chartPriceList = new Chart(ctx, config);
    return window.chartPriceList;
    // return new Chart(ctx, config);
  }
  ...
  var initialChart3 = function() {
    ...
    // Init ChartJS -- for more info, please visit: https://www.chartjs.org/docs/latest/
    window.chartSources = new Chart(ctx, config);
    return window.chartSources;
    // return new Chart(ctx, config);
  }
  ...
  var initialChart4 = function() {
    ...
    // Init ChartJS -- for more info, please visit: https://www.chartjs.org/docs/latest/
    window.chartNewLeads = new Chart(ctx, config);
    return window.chartNewLeads;
    // return new Chart(ctx, config);
  }
  ...
  var initialChart5 = function() {
    ...
    // Init ChartJS -- for more info, please visit: https://www.chartjs.org/docs/latest/
    window.chartMajorRate = new Chart(ctx, config);
    return window.chartMajorRate;
    // return new Chart(ctx, config);
  }
  ...
  var initialChart6 = function() {
    ...
    var warningColor = TI_Util.getCssVariableValue('--bs-warning');
    ...
    window.chartStatusRate = new Chart(ctx, config);
    return window.chartStatusRate;
    // return new Chart(ctx, config);
  }

  return {
    init: function() {
    var myChart1 = initialChart();
      initialChart2();
      initialChart3();
      initialChart4();
      initialChart5();
