...
@section('header', 'Quản lý sinh viên chính thức')
{{-- <script type="module" src="{{ asset('assets/crm/js/htecomJs/officialStudent.js') }}" ></script> --}}
<script type="module" src="{{ asset('assets/crm/js/htecomJs/officialStudent.js') }}{{ env('ASSET_VERSION') ? '?v=' . env('ASSET_VERSION') : '' }}"></script>
<script type="module" src="{{ asset('assets/crm/js/htecomJs/Lead/changeStatusLead.js') }}{{ env('ASSET_VERSION') ? '?v=' . env('ASSET_VERSION') : '' }}" ></script>
<script type="module" src="{{ asset('assets/crm/js/htecomJs/deleteItem.js') }}{{ env('ASSET_VERSION') ? '?v=' . env('ASSET_VERSION') : '' }}" ></script>
<script type="module" src="{{ asset('assets/crm/js/htecomJs/Lead/changeEmployeeForLead.js') }}{{ env('ASSET_VERSION') ? '?v=' . env('ASSET_VERSION') : '' }}" ></script>
<script type="module" src="{{ asset('assets/crm/js/htecomJs/exportItems.js') }}{{ env('ASSET_VERSION') ? '?v=' . env('ASSET_VERSION') : '' }}" ></script>
<script type="module" src="{{ asset('assets/crm/js/htecomJs/convertStudentToLead.js') }}{{ env('ASSET_VERSION') ? '?v=' . env('ASSET_VERSION') : '' }}" ></script>
@section('content')
    <div class="px-6">
        ...
        <div class="app_breadcrumb d-flex align-items-center justify-content-between">
            ...
            <div class="x-3 py-4">
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-700 fw-bold lh-1">Quản lý Sinh viên chính thức</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-primary">Danh sách sinh viên chính thức</li>
                    <!--end::Item-->
                </ul>
            </div>
            <!--end:Breadcrumb-->
        ...
        <div class="card">
            ...
            <div class="card-header p-4">
                ...
                <div
                    ...
                    <!--begin::Title-->
                    <h3 class="card-title text-dark fw-bolder m-md-0">Danh sách sinh viên chính thức</h3>
                    <!--end::Title-->
                    ...
                    <div class="d-flex align-items-center gap-2 gap-md-0 mx-auto ms-md-auto me-md-0 mb-3 mb-md-0">
                        ...
                        <div class="w-100 position-relative mb-lg-0" autocomplete="off">
                            ...
                            <!--end::Icon-->
                            <!--begin::Input-->
                            <input id="search-table-students" type="search"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button id="btn_group_leads_submit" type="button" data-types="1" class="btn btn-primary">Tạo
                                                nhóm</button>
            ...
            <div class="card-body p-4">
                <div
                    ...
                    <div class="d-flex flex-wrap flex-md-nowrap flex-md-row flex-grow-1 gap-1 gap-lg-0">
                        ...
                        <div class="vr d-none d-lg-block text-gray-400 mx-3"></div>
                        <select id="assignment-filter" data-result-template="data-result-template-1" data-placeholder-length="140" data-label="Chọn tư vấn viên"
                            ...
                            data-dropdown-css-class="w-fit" data-select-all-label="Tất cả tư vấn viên"
                            class="data-filter form-select form-select-sm" multiple>
                ...
                <div class="table-responsive position-relative border rounded-3 my-3">
                    <!--begin::Table-->
                    <table id="table_students" class="table table-sm table-striped table-crm table-row-devider-300 bordered rounded-3 m-0"id="table">
                        <!--begin::Table head-->
                        <thead>
            ...
            <div class="modal-content" style="max-width: 444px">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-3">
                        <button id="btn_delete_item" data-type="student" data-dataTableName="#table-leads" type="button" class="btn btn-primary" data-id="0">Xác
                            nhận</button>
    ...
    <script>
        var selecter_status = ` class="student_status_select w-auto form-select form-select-sm" data-label="Chọn trạng thái">
    ...
    @include('crm.content.officialStudent.notification_student')
    @include('crm.content.officialStudent.modal_convert_student')
    @include('crm.content.officialStudent.modal_exports_for_students')
