            ...
            <div class="x-3 py-4">
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                    ...
                    <li class="breadcrumb-item text-gray-700 fw-bold lh-1">
                        <a href="{{ route('crm.official.student') }}">
                            Sinh viên
                        </a>
                    </li>
                    <!--end::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-primary">Chi tiết thông tin Sinh viên</li>
                    <!--end::Item-->
                </ul>
            </div>
            <!--end:Breadcrumb-->
            ...
            <div class="card-header p-4">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin:back button-->
                        <a href="{{route('crm.official.student')}}" class="btn btn-ghost btn-sm">
                            <img src="assets/crm/media/svg/crm/chevron-left.svg" width="24" height="24" />
                        </a>
                        <!--end:back button-->
                        <!--begin::Title-->
                        <h3 class="card-title text-dark fw-bolder m-md-0">Chi tiết thông tin sinh viên</h3>
                        <!--end::Title-->
                    </div>
                    <!--begin::Actions-->
                    <div class="d-flex justify-content-end">
                        <!--begin:Action Buttons-->
                        <div class="d-flex align-items-center gy-2 gap-1 group_btn_detail_student">
                            ...
                            @endif
                            @php
                                $voipConfig = DB::table('config_voip')->where('id', 1)->first();
                            @endphp
                            ...
                            {{-- <input id="voip_number_sip" type="text" hidden value="{{ env('VOIP_LINE') ?? '' }}">
                            <input id="voip_password_sip" type="text" hidden value="{{ env('VOIP_PASSWORD') ?? '' }}"> --}}
                            ...
                            <div class="col-12 col-lg-7 col-xl-12">
                                <div
                                    ...
                                    <div class="symbol rounded-full overflow-hidden symbol-90px me-5 ava">
                                        {{-- @foreach ($dataId->files as $itemImg)
                                            @if($itemImg->types == 0 && $itemImg != '')
                                                <img src="{{$itemImg->image_url ? $itemImg->image_url : '/assets/crm/media/svg/avatars/blank.svg'}}" class="h-90 align-self-center"
                                                    alt="">
                                                @break
                                            @else
                                                <img src="{{'/assets/crm/media/svg/avatars/blank.svg'}}" class="h-90 align-self-center"
                                                alt="">
                                                @break
                                            @endif
                                        @endforeach --}}
                                        @if (count($dataId->files) > 0)
                                            @foreach ($dataId->files as $itemImg)
                                                @if($itemImg->types == 0 && $itemImg != '')
                                                    <img src="{{$itemImg->image_url ? $itemImg->image_url : '/assets/crm/media/svg/avatars/blank.svg'}}" 
                                                        class="h-90 align-self-center" alt="">
                                                    @break
                                                @else
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-row-fluid flex-wrap name_lead">
                                        ...
                                        <div class="flex-grow-1 me-2">
                                            ...
                                            <span class="d-block fs-8">Trạng thái: <span class="text-warning">
                                ...
                                <div
                                    ...
                                    <div class="input-group min-w-150px">
                                        ...
                                        <button type="button"
                                            ...
                                            aria-describedby="acc_phone">{{ $dataId->phone ? $dataId->phone : '' }}</button>
                                    </div>
                                    <div class="input-group min-w-150px">
                                        <span class="input-group-text border border-primary bg-primary text-white px-2"
                                            id="acc_email">
                    ...
                    <div class="col-12 col-xl-9 border-bottom border-gray-300">
                        <div class="d-flex overflow-x-auto flex-stack h-100 gap-4 py-9 ">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-start h-100 text-left">
                                ...
                                <div class="d-flex flex-stack py-2">
                                    ...
                                    <div class="symbol rounded-full overflow-hidden symbol-40px me-2">
                                        <img src="{{$dataId->employees->avatar ?? 'assets/crm/media/svg/avatars/blank.svg'}}" class="h-40 align-self-center"
                                            alt="">
                                    </div>
                                    <!--end::Symbol-->
                            ...
                            <div
                                ...
                                <span class="fs-1 text-primary total_data_call">10</span>
                            </div>
                            <div class="vr d-none d-md-block text-gray-400 mx-8"></div>
                    ...
                    <div class="col-3 d-none d-xl-block border-start border-end border-gray-300">
                        <div
                            ...
                            <div class="input-group w-auto">
                                ...
                                @if(auth()->user()->id != 1 && $currentEmployeeId == $dataId->employees->id)
                                    <button type="button"
                                        class="form-control btn btn-outline bg-opacity-20 btn-outline-primary fs-7 px-2 btn_call_voip"
                                        aria-describedby="acc_phone" data-phone={{$dataId->phone ? $dataId->phone : '' }}>{{ $dataId->phone ? $dataId->phone : '' }}
                                    </button>
                                @else
                                    <button type="button"
                                        class="form-control btn btn-outline bg-opacity-20 btn-outline-primary fs-7 px-2"
                                        aria-describedby="acc_phone" data-phone={{$dataId->phone ? $dataId->phone : '' }} disabled>
                                        {{ $dataId->phone ? $dataId->phone : '' }}
                                    </button>
                                @endif
                            </div>
                                        ...
                                        <div class="accordion-body pt-1">
                                            <div class="rounded border border-gray-200 p-4">
                                                <div class="row gy-2">
                                                    ...
                                                    <div class="col-6">{{ $dataId->students_code ? $dataId->students_code : '' }}</div>
                                            ...
                                            <div class="rounded border border-gray-200 p-4">
                                                <div class="row gy-2">
                                                    <div class="col-6 text-gray-700"><i class="fas fa-layer-group"></i>
                                                        Nguồn</div>
                                                    <div class="col-6">{{ $dataId->sources ? $dataId->sources->name : ''}}</div>
                    ...
                    <div class="col-12 col-xl-9">
                        <div class="d-flex flex-column justify-content-start p-4">
                            <ul class="crm_tabs nav nav-tabs nav-small-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <button class="nav-link" id="learning-fee-tab" data-bs-toggle="tab"
                            ...
                            <div class="tab-content mt-2" id="myTabContent">
                                ...
                                <!--begin::Học phí-->
                                @include('crm.content.officialStudent.price_list_tab_student')
                                <!--end::Học phí-->
                                <!--begin::Giao dịch-->
                                @include('crm.content.officialStudent.transaction_tab_student')
                                <!--end::Giao dịch-->
                            </div>
                        </div>
                    </div>
