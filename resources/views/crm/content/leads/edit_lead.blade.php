        ...
        <div class="card">
            ...
            <div class="card-header p-2">
                ...
                <div class="app-toolbar-wrapper d-flex flex-row flex-wrap align-items-center w-100">
                    ...
                    <!--end:back button-->
                    <!--begin::Title-->
                    <h3 class="card-title text-dark fw-bolder m-md-0">Chỉnh sửa thông tin thí sinh</h3>
                    <!--end::Title-->
            ...
            <!--end::Toolbar-->
            <form id="edit-lead-form" data-attr="lead">
                <!--begin::Body-->
                    ...
                    <div class="row gx-3 pt-6">
                        ...
                        <div class="col-lg-6 col-md-3">
                            ...
                            <div class=" p-4 d-flex align-items-center justify-content-end gap-3 h-100">
                                <button id="edit_lead_btn_submit" type="submit" class="btn btn-primary edit_lead_btn_submit" data-id="{{$dataId->id}}">Đăng thông tin</button>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-6 edit_lead_code_wrapper">
                                <label for="candidate_name" class="form-label">Mã số sinh viên 
                                    <!-- <span class="text-danger">*</span> -->
                                </label>
                                <input value="{{ $dataId->leads_code ?? null }}" type="text" id="edit_lead_code" name="candidate_code"
                                    aria-label="Nhập họ tên thí sinh" placeholder="Mã số sinh viên"
                                    class="form-control"/>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-6 edit_lead_email_wrapper">
                                <label for="candidate_email" class="form-label">Email 
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-6 edit_lead_dateOfBirth_wrapper">
                                ...
                                <input value="{{ $dataId->date_of_birth ?? null }}" type="date" id="edit_lead_dateOfBirth" 
                                       name="candidate_dob" class="form-control" />
                                <p class="error-input mt-1"></p>
                            </div>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-6 edit_lead_identification_card_wrapper">
                                ...
                                <div class="input-group">
                                    <input value="{{ $dataId->identification_card ?? null }}" type="text" id="edit_lead_identification_card" 
                                           name="candidate_id_number" class="form-control" maxlength="12">                                    
                                </div>
                                <p class="error-input mt-1"></p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-6 edit_lead_status_wrapper">
                                ...
                                <select id="edit_lead_status" name="candidate_adv_status" aria-label="Chọn trạng thái"
                                    ...
                                    class="form-select">
                                    <option value="" selected>Tình trạng tư vấn</option>
                                    @foreach ($dataFilter['status'] as $status)                                        
                                        <option value="{{ $status->id }}" {{ isset($dataId['lst_status_id']) && $dataId['lst_status_id'] == $status['id'] ? 'selected' : '' }}>
                                            {{ $status->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-6 edit_lead_major_wrapper">
                                <label for="candidate_majors_of_interest" class="form-label">
                                    Ngành học quan tâm
                                    <span class="text-danger">*</span>
                                </label>
                        ...
                        <!-- Nguồn -->
                        <div class="col-12 col-md-6">
                            <div class="edit_lead_source_wrapper">
                                ...
                                <select id="edit_lead_source" name="candidate_source" aria-label="Chọn nguồn"
                                    ...
                                    @endforeach
                                    {{-- @foreach ($dataFilter['sources']->filter(function ($source) {
                                        return $source->sources_types === null;
                                    }) as $sources)
                                        <option value="{{ $sources->id }}"
                                            {{ (isset($dataId->sources) && $dataId->sources->id == $sources->id) ? "selected" : '' }}>
                                            {{ $sources->name }}
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-6 edit_lead_employees_wrapper">
                                ...
                                <input type="hidden" id="edit_lead_employees_old" name="candidate_agent" value="{{ isset($dataId->employees) ? $dataId->employees->id : '' }}">
                                <p class="error-input mt-1"></p>
                            </div>
                        </div>
                ...
                <div class="card-footer my-0 py-0">
                    <div class="row gx-6">                        
                        ...
                        <div class="col-12 col-md-12">
                            <!--begin::Actions-->
                            <div class=" p-4 d-flex align-items-center justify-content-end gap-3 h-100">
                                <button id="edit_lead_btn_submit" type="submit" class="btn btn-primary edit_lead_btn_submit" data-id="{{$dataId->id}}">Đăng thông
                                    tin</button>
                                {{-- <button type="button" class="btn btn-secondary">Hủy</button> --}}
                            </div>
                            <!--end::Actions-->
