        ...
        <div class="modal-content" style="max-width: 444px">
            ...
            <div class="modal-body">
                ...
                <div class="notice-text d-flex flex-column justify-content-center align-items-center"
                    style="font-size:24px;font-weight:600;margin-bottom:15px;"> Chuyển các sinh viên tiềm năng này thành sinh viên? </div>
                <div class="d-flex justify-content-center align-items-center gap-3">
                    <button id="btn_convert_lead" type="button" class="btn btn-primary" data-id="0">Xác nhận</button>
