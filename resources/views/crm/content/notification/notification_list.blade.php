...
@section('content')
    <div class="px-6">
        ...
        <div class="card bg-transparent">
            ...
            <div class="card-header pt-4 px-0">
                ...
                <div class="app-toolbar-wrapper d-flex flex-row flex-wrap align-items-center w-100">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-md-0 mx-auto ms-md-auto me-md-0 mb-3 mb-md-0">
                        ...
                        <form class="w-100 position-relative mb-lg-0" autocomplete="off" action="{{ route('crm.notification.list') }}" method="GET">
                            ...
                            <input type="text" name="search" value="{{ request()->get('search') }}" placeholder="Tìm kiếm..." 
                                     class="search-input form-control form-control-sm border border-gray-300 rounded h-lg-45px ps-13" width="22" height="22">
                            <div class="row">
                                {{-- <div class="col-md-6">
                                    <input type="text" name="search" value="{{ request()->get('search') }}" placeholder="Tìm kiếm..." 
                                     class="search-input form-control form-control-sm border border-gray-300 rounded h-lg-45px ps-13" width="22" height="22">
                                ...
                                <div class="col-md-6">
                                    <button id="btn_import_notification" type="button"  class="btn btn-primary d-flex align-items-center gap-2 crm_notification_pricelist mx-2"
                                        data-bs-toggle="modal" data-bs-target="#modal_import_notification_for_account">
                                        <img src="assets/crm/media/svg/crm/upload.svg" width="25" height="20" />
                                        <span class="d-none d-md-block px-4 py-0">Nhập dữ liệu</span>
                                    </button>                                                              
                                </div> --}}
                            </div>
                            <!--end::Input-->
                    ...
                    <!--begin::Search & Sort-->
                    <button id="btn_import_notification" type="button"  class="btn btn-primary d-flex align-items-center gap-2  mx-2"
                        data-bs-toggle="modal" data-bs-target="#modal_import_notification_for_account">
                        <img src="assets/crm/media/svg/crm/upload.svg" width="25" height="20" />
                        <span class="d-none d-md-block px-4 py-0">Nhập dữ liệu</span>
                    </button>
                                ...
                                <div class="d-flex flex-column flex-grow-1 align-items-start">
                                    <span class="d-flex align-items-center gap-1 text-muted">
                                        @if($notification->created_at != null)
                                            ...
                                            {{ $notification->created_at ? \Carbon\Carbon::parse($notification->created_at)->format('H:i') . ' • ' . \Carbon\Carbon::parse($notification->created_at)->format('d/m/Y') : '' }}
                                        @endif
                            ...
                            <div class="col-6 py-5">
                                <nav aria-label="Pagination">
                                    <ul class="pagination">
                                        ...
                                        @if ($startPage > 1)
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $data->url(1) . '&search=' . request()->get('search') }}">1</a>
                                            </li>
                                            @if ($startPage > 2)
                                        ...
                                        {{-- Hiển thị trang từ startPage đến endPage --}}
                                        ...
                                        @if ($endPage < $totalPages)
                                            ...
                                            @endif
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $data->url($totalPages) . '&search=' . request()->get('search') }}">{{ $totalPages }}</a>
                                            </li>
                                        @endif
        ...
        <!--end::Content-->
        <script type="module" src="{{ asset('assets/crm/js/htecomJs/import_notification_for_account.js') }}" ></script>
        @include('crm.content.notification.modal_import_account_for_students')
