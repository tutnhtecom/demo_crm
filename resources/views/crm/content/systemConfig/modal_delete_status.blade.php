    ...
    <div class="modal-dialog" style="margin-top:160px;">
        <div class="modal-content" style="max-width: 444px">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-center align-items-center" style="font-size:24px;font-weight:600;margin-bottom:15px;"> Xóa trạng thái này? </div>
                <div class="d-flex justify-content-center align-items-center gap-3">
                    <button id="btn_delete_status" type="button" class="btn btn-primary btn_delete_status" data-id="{{$status['id']}}">Xác nhận</button>
