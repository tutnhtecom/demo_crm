...
class EmailTemplateTypesServices implements EmailTemplateTypesInterface
{
    
    protected $e_tmp_type_repository;
    public function __construct(EmailTemplateTypesRepository $e_tmp_type_repository)
    {
        $this->e_tmp_type_repository = $e_tmp_type_repository;   
    }
    public function index($params) {
        try {
            $model = $this->e_tmp_type_repository;
    ...
    public function details($id) {
       try {
         $model = $this->e_tmp_type_repository->where('id', $id, '=')->first();
         if(isset($model->id)) {
            $result = [
                "code" => 200,                
                "data" => $model
    ...
    public function create($params) {
       try {
            ...
            $model = $this->e_tmp_type_repository->create($data);
            $result = null;
            if(isset($model->id)) {
                $result = [
                    "code" => 200,
    ...
    public function update($params, $id) {
        ...
        try {
            ...
            $model = $this->e_tmp_type_repository->updateById($id, $params);
            $result = null;
            if(isset($model->id)) {
                $result = [
                    "code" => 200,
    ...
    public function delete($id) {
        try {
            ...
            $model = $this->e_tmp_type_repository->updateById($id, $data); 
            $result = null;
            if($model) {
                $result = [
                    "code" => 200,
