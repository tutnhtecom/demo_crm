...
class CreateConfigVoipRequest extends FormRequest
{
    ...
    {        
        return [                        
            'api_key'       => ['required', 'unique:config_voip,api_key'],
            'api_secret'    => ['required', 'unique:config_voip,api_secret'],
            'voip_ip'       => ['required', 'unique:config_voip,voip_ip'],
        ];
    }
