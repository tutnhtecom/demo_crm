...
class CreateTransactionsRequest extends FormRequest
{
    ...
    // {
    //     $this->merge([
    //         'tran_date' => now()->format('d/m/Y'),
    //         'tran_time' => now()->format('H:i'),
    //     ]);
    // }
    ...
    public function rules()
    {
        ...
        $rules = [
            'code'              => ['nullable', "min:1", "max:150", 'unique:transactions,code'],
            ...
            "price_lists_id"    => ["required", function ($attribute, $value, $fail) {
    ...
    public function messages()
    {
        return [
            ...
            'price_lists_id.required'     => 'Vui lòng nhập chọn  hóa đơn',
            'code.required'               => 'Vui lòng nhập Tên giao dịch',
            'code.max'                    => 'Độ dài tối đa 155 ký tự',
            'code.min'                    => 'Độ dài tối thiểu 1 ký tự',
            ...
            'name.min'                    => 'Độ dài tối thiểu 1 ký tự',
